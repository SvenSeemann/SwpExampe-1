...
public abstract class JavaScriptDateTimeFormatters {
     ...
     */
    public static final DateTimeFormatter javaScriptISODateTimeFormat = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSX").withLocale(Locale.ENGLISH);
     ...
     */
    public static final DateTimeFormatter javaScriptUTCDateTimeFormat = DateTimeFormatter.ofPattern("EEE, dd MMM yyyy HH:mm:ss zzz").withLocale(Locale.ENGLISH);
}
